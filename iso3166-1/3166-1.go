...
var (
	countryByName    = make(map[string]*goiso.Country)
	countryByAlpha2  = make(map[string]*goiso.Country)
	countryByAlpha3  = make(map[string]*goiso.Country)
	countryByNumeric = make(map[string]*goiso.Country)
)
...
func GetByName(name string) *goiso.Country {
	return countryByName[name]
}

func GetByAlpha2(alpha2 string) *goiso.Country {
	return countryByAlpha2[alpha2]
}

func GetByAlpha3(alpha3 string) *goiso.Country {
	return countryByAlpha3[alpha3]
}

func GetByNumeric(numeric string) *goiso.Country {
